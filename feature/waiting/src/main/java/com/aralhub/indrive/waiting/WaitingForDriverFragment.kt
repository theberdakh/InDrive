...
import com.aralhub.indrive.waiting.databinding.FragmentWaitingForDriverBinding
import com.aralhub.indrive.waiting.modal.CancelWaitingFragment
import com.aralhub.indrive.waiting.modal.TripCanceledByDriverFragment
import com.aralhub.indrive.waiting.modal.WaitingTimeFragment
...
@AndroidEntryPoint
class WaitingForDriverFragment : Fragment(R.layout.fragment_waiting_for_driver) {
    ...
    private val binding by viewBinding(FragmentWaitingForDriverBinding::bind)
    ...
    private fun showCancelWaitingBottomSheet() {
        CancelWaitingFragment().show(childFragmentManager, CancelWaitingFragment.TAG)
    }
